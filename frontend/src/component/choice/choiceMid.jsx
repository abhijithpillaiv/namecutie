...
function Mid() {
  ...
  const {serchName}=useContext(search)
    ...
    return  databoy&&datagirl&&dataunisex? <div className="event-schedule-area-two bg-color pad100">
        ...
        {serchName? <NametableSearch props={databoy} /> : <Nametable  props={databoy}/>}
              </div>
              <div className="col-lg-4">
                  ...
                  {serchName? <NametableSearch props={datagirl} /> : <Nametable  props={datagirl}/>}
              </div>
              ...
              <div className="col-lg-4">
                  ...
                  {serchName? <NametableSearch props={dataunisex} /> : <Nametable  props={dataunisex}/>}
              </div>
