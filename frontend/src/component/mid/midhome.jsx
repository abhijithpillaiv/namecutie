...
function Mid() {
  ...
  return databoy && datagirl && dataunisex ? (
      ...
      <div className="container-fluid">
        <div className="row">
          <div className="col-lg-4">
            ...
            {serchName ? (
              <NametableSearch gender={"BOYS"} props={databoy} />
            ) : (
              <Nametable gender={"BOYS"} props={databoy} />
            )}
          </div>
          <div className="col-lg-4">
            ...
            {serchName ? (
              <NametableSearch gender={"GIRLS"} props={datagirl} />
            ) : (
              <Nametable gender={"GIRLS"} props={datagirl} />
            )}
          </div>
            ...
            <ul className="nav custom-tab custom-tab_u">
              <li>
                <Link
                  ...
                  aria-selected="true"
                >
                  <span className="unisex">UNISEX</span>
                </Link>
              </li>
            </ul>
            {serchName ? (
              <NametableSearch gender={"UNISEX"} props={dataunisex} />
            ) : (
              <Nametable gender={"UNISEX"} props={dataunisex} />
            )}
          </div>
        </div>
      </div>
